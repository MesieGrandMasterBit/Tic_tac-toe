...
// - Если пользователь выбирает уже используемую "сторону" или несуществующую, то его просят сделать корректный выбор
// - 
void chose_sign(int *sock, char *sign) {
...
// - Выбор "сторон" у клиентов
// - Обработчик победителя
// - Очерёдность ходов у игроков, до победы или ничьей
void client_handler(int sock) {
    char sign;
